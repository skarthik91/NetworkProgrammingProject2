...
int		rtt_d_flag1 = 0;		/* debug flag; can be set by caller */
...
/* include rtt_ts */
uint32_t rtt_ts1(struct rtt_info *ptr)
{
    uint32_t		ts;
    struct timeval	tv;
...
void
rtt_newpack1(struct rtt_info *ptr)
{
    ptr->rtt_nrexmt = 0;
}
...
{
    return((int) (ptr->rtt_rto + 0.5));		/* round int to int */
...
void
rtt_debug1(struct rtt_info *ptr)
{
    if (rtt_d_flag1 == 0)
        return;
